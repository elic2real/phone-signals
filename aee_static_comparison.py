"""AEE vs Static TP/SL Analysis - Compare AEE performance to static exits at different target sizes."""
...
def analyze_bucket_performance(bucket_name: str, zones: List[Any]):
    """Analyze AEE vs static TP/SL performance for a bucket."""
    ...
    print(f"\n{'='*60}")
    print(f"{bucket_name} BUCKET ANALYSIS ({len(zones)} zones)")
    print(f"{'='*60}")
...
def main():
    ...
    print("AEE vs STATIC TP/SL ANALYSIS")
    print("=" * 50)
